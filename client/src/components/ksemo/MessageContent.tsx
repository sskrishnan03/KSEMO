                ...
                {userLong && (
                  <>
                    <div
                      ...
                      aria-hidden="true"
                    />
                    <span className="absolute -bottom-2.5 -right-3.5 flex items-center gap-1 rounded-full px-3 py-1 text-[15px] font-semibold text-foreground/60 transition-colors hover:bg-accent hover:text-foreground">
                      Show more
              ...
              <>
                ...
                {userLong && (
                  <button
                    ...
                    className="mt-1 flex items-center gap-1 self-end rounded-full px-3 py-1 text-[15px] font-semibold text-foreground/60 transition-colors hover:bg-accent hover:text-foreground"
                  >
                    Show less
