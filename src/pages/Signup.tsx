    ...
    >
      <div className="space-y-4">
        ...
        <div className="relative w-full">
          <Button variant="outline" className="w-full h-11 justify-center rounded-xl border border-white/10 text-[14px] font-medium text-white hover:bg-white/5 transition" disabled={loading} type="button">
          ...
          <div 
            ...
            className="absolute inset-0 opacity-[0.01] overflow-hidden flex justify-center cursor-pointer"
          />
        </div>
